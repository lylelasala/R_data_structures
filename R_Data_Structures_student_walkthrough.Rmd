...
student_names <- c("John", "Jimmy", "Jane", "Jason", "Jenny")
...
```{r}
student_name <- c("john", "Jason", "Jenny")
student_grade_level <- c("freshman", "sophomore", "senior" )
